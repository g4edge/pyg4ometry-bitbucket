# Generated from RegionLexer.g4 by ANTLR 4.9
from antlr4 import *
...
class RegionLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "Whitespace", "InLineComment", "LineComment", "Newline", "Integer", 
            "RegionName", "BodyName", "Plus", "Minus", "Bar", "LParen", 
            "RParen" ]

    ruleNames = [ "Whitespace", "InLineComment", "LineComment", "Newline", 
                  "Integer", "Digit", "RegionName", "BodyName", "Plus", 
                  "Minus", "Bar", "LParen", "RParen" ]
