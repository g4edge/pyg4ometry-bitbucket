...
def Test(vis=False, interactive=False):
    ...
    w = _gd.Writer()
    w.addDetector(reg)
    w.write(_os.path.join(_os.path.dirname(__file__), "T607_LvChangeAndClipSolid.gdml"))
    w.writeGmadTester(_os.path.join(_os.path.dirname(__file__),"T607_LvChangeAndClipSolid.gmad"),"T607_LvChangeAndClipSolid.gdml")
