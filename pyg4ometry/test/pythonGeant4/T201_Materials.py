...
def Test_MaterialCompoundMassFraction() :
    ...
    w.writeGmadTester(_os.path.join(_os.path.dirname(__file__),"T201_MaterialCompound.gdml"),"T201_MaterialCompound.gdml")
...
def Test_MaterialCompoundAtoms() :
    ...
    w = _gd.Writer()
    w.addDetector(reg)
    w.write(_os.path.join(_os.path.dirname(__file__), "T201_MaterialCompoundAtoms.gdml"))
    w.writeGmadTester(_os.path.join(_os.path.dirname(__file__),"T201_MaterialCompoundAtoms.gmad"),"T201_MaterialCompoundAtoms.gdml")
