...
def Test(vis = False, interactive = False, n_slice = 20, n_stack = 20, scale=[-1,1,1], title="T114_physical_reflection_x"):
    reg = _g4.Registry()
    ...
    w.writeGmadTester(_os.path.join(_os.path.dirname(__file__),title+".gmad"),title+".gdml")
