...
def Test(vis = False, interactive = False) :
    ...
    bs = _g4.solid.Box("bs",1.1*bx,0.9*bx,0.9*bx, reg, "mm")
    ...
    bp1 = _g4.PhysicalVolume([0.0,0,0],  [-bx,0,0],  bl, "b_pv1", rl, reg)
    bp2 = _g4.PhysicalVolume([0.0,0,0],  [0  ,0,0],  bl, "b_pv2", rl, reg)
    bp3 = _g4.PhysicalVolume([0.0,0,0],[bx ,0,0],  bl, "b_pv3", rl, reg)
    ...
    w = _gd.Writer()
    w.addDetector(reg)
    w.write(_os.path.join(_os.path.dirname(__file__), "T104_overlap_volu.gdml"))
