...
def Test(vis = False, interactive = False) :
    ...
    asPV2 = _g4.PhysicalVolume([0,_np.pi/15,_np.pi/6],  [10,-20,5],  assembly, "part_pv2", worldLV, reg)
    asPV3 = _g4.PhysicalVolume([0,-_np.pi/15,_np.pi/6], [-40,-20,5], assembly, "part_pv3", worldLV, reg)
