...
class FlairLoadTests(_unittest.TestCase) :
    ...
    def test_FlairLoad_T009_ARB(self):
        flairLoadWriteTest("009_ARB.inp", True, False)

    def test_FlairLoad_T009_ARB_cube_anticlockwise(self):
        flairLoadWriteTest("009_ARB_cube_anticlockwise.inp", True, False)

    def test_FlairLoad_T009_ARB_cube_clockwise(self):
        flairLoadWriteTest("009_ARB_cube_clockwise.inp", True, False)
    ...
    def test_FlairLoad_T021_QUA_hyperboloid(self):
        flairLoadWriteTest("021_QUA_hyperboloid.inp", True, False)
    ...
    def test_FlairLoad_T302_BOX_transform(self):
        flairLoadWriteTest("302_BOX_transform.inp", True, False)

    def test_FlairLoad_T303_SPH_transform(self):
        flairLoadWriteTest("303_SPH_transform.inp", True, False)

    def test_FlairLoad_T304_RCC_transform(self):
        flairLoadWriteTest("304_RCC_transform.inp", True, False)

    def test_FlairLoad_T305_REC_transform(self):
        flairLoadWriteTest("305_REC_transform.inp", True, False)

    def test_FlairLoad_T306_TRC_transform(self):
        flairLoadWriteTest("306_TRC_transform.inp", True, False)

    def test_FlairLoad_T307_ELL_transform(self):
        flairLoadWriteTest("307_ELL_transform.inp", True, False)

    def test_FlairLoad_T308_RAW_transform(self):
        flairLoadWriteTest("308_RAW_transform.inp", True, False)

    def test_FlairLoad_T308_WED_transform(self):
        flairLoadWriteTest("308_WED_transform.inp", True, False)

    def test_FlairLoad_T309_ARB_transform(self):
        flairLoadWriteTest("309_ARB_transform.inp", True, False)

    def test_FlairLoad_T310_XYP_transform(self):
        flairLoadWriteTest("310_XYP_transform.inp", True, False)

    def test_FlairLoad_T310_XZP_transform(self):
        flairLoadWriteTest("310_XZP_transform.inp", True, False)

    def test_FlairLoad_T310_YZP_transform(self):
        flairLoadWriteTest("310_YZP_transform.inp", True, False)

    def test_FlairLoad_T311_PLA_transform(self):
        flairLoadWriteTest("311_PLA_transform.inp", True, False)

    def test_FlairLoad_T312_XCC_transform(self):
        flairLoadWriteTest("312_XCC_transform.inp", True, False)

    def test_FlairLoad_T312_YCC_transform(self):
        flairLoadWriteTest("312_YCC_transform.inp", True, False)

    def test_FlairLoad_T312_ZCC_transform(self):
        flairLoadWriteTest("312_ZCC_transform.inp", True, False)

    def test_FlairLoad_T313_XEC_transform(self):
        flairLoadWriteTest("313_XEC_transform.inp", True, False)

    def test_FlairLoad_T313_YEC_transform(self):
        flairLoadWriteTest("313_YEC_transform.inp", True, False)

    def test_FlairLoad_T313_ZEC_transform(self):
        flairLoadWriteTest("313_ZEC_transform.inp", True, False)

    def test_FlairLoad_T314_QUA_transform(self):
        flairLoadWriteTest("314_QUA_transform.inp", True, False)

    def test_FlairLoad_T320_cube_from_halfspaces_transform(self):
        flairLoadWriteTest("320_cube_from_halfspaces_transform.inp", True, False)

    def test_FlairLoad_T321_cube_from_plas_transform(self):
        flairLoadWriteTest("321_cube_from_plas_transform.inp", True, False)

    def test_FlairLoad_T601_filter_redundant_halfspaces(self):
        flairLoadWriteTest("601_filter_redundant_halfspaces.inp", True, False)

    def test_FlairLoad_T701_LATTICE(self):
        flairLoadWriteTest("701_LATTICE.inp", True, False)

    def test_FlairLoad_T702_LATTICE(self):
        flairLoadWriteTest("702_LATTICE.inp", True, False)

    def test_FlairLoad_T703_LATTICE(self):
        flairLoadWriteTest("703_LATTICE.inp", True, False)

    def test_FlairLoad_T801_nested_expansion(self):
        flairLoadWriteTest("801_nested_expansion.inp", True, False)

    def test_FlairLoad_T802_nested_translation(self):
        flairLoadWriteTest("802_nested_translation.inp", True, False)

    def test_FlairLoad_T803_nested_transform(self):
        flairLoadWriteTest("803_nested_transform.inp", True, False)

    def test_FlairLoad_T804_recursive_transform(self):
        flairLoadWriteTest("804_recursive_transform.inp", True, False)

    def test_FlairLoad_T805_inverse_transform(self):
        flairLoadWriteTest("805_inverse_transform.inp", True, False)
    ...
    def test_FlairLoad_Tex_geometry(self):
        flairLoadWriteTest("ex-geometry.inp", True, False)

    def test_FlairLoad_Tex_Scoring(self):
        flairLoadWriteTest("ex_Scoring.inp", True, False)

    def test_FlairLoad_Texample_running(self):
        flairLoadWriteTest("example_running.inp", True, False)

    def test_FlairLoad_Texample_score(self):
        flairLoadWriteTest("example_score.inp", True, False)

    def test_FlairLoad_TmanualSimpleFileFixed(self):
        flairLoadWriteTest("manualSimpleFileFixed.inp", True, False)

    def test_FlairLoad_TmanualSimpleFileFree(self):
        flairLoadWriteTest("manualSimpleFileFree.inp", True, False)
