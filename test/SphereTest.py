...
def pycsgmeshTest(vtkViewer = True, gdmlWriter = True) :
    ...
    sphereSolid1    = _g4.solid.Sphere2('sphere1',30,50,0,_np.pi*2,0.85*_np.pi,0.15*_np.pi)
    ...
    sphereSolid2    = _g4.solid.Sphere2('sphere2',30,50,0,2*_np.pi,2.*_np.pi/3.,11*_np.pi/60.)
    ...
    sphereSolid3    = _g4.solid.Sphere2('sphere3',30,50,0,_np.pi*2,_np.pi/3.,_np.pi/3.)
    ...
    sphereSolid4    = _g4.solid.Sphere2('sphere4',30,50,0,_np.pi*2,0.15*_np.pi,11*_np.pi/60.)
    ...
    sphereSolid5    = _g4.solid.Sphere2('sphere5',30,50,0,_np.pi*2,0, 0.15*_np.pi)
