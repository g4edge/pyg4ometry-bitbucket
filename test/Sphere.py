...
def pycsgmeshTest(vtkViewer = True, gdmlWriter = True) :
    ...
    sphereSolid2    = _g4.solid.Sphere('sphere2',0,50,0,_np.pi*2./3.,0,_np.pi*2)
    ...
    sphereSolid3    = _g4.solid.Sphere('sphere3',0,50,0,_np.pi,0,_np.pi*2./3)
    ...
    sphereSolid4    = _g4.solid.Sphere('sphere4',25,50,0,_np.pi,0,_np.pi*2)
    ...
    sphereSolid5    = _g4.solid.Sphere('sphere5',25,50,0,_np.pi*2./3.,0,_np.pi*2)
