...
def pycsgmeshTest(vtkViewer = True, gdmlWriter = True) :
    ...
    ellipsoidSolid1    = _g4.solid.Ellipsoid("ellipsoid_solid1", 40., 60., 200., -10., 70.)
    ...
    ellipsoidSolid2    = _g4.solid.Ellipsoid("ellipsoid_solid2", 40., 60., 200., -10., 70.)
    ...
    ellipsoidSolid3    = _g4.solid.Ellipsoid("ellipsoid_solid3", 40., 60., 200., -10., 70.)
    ...
    ellipsoidSolid4    = _g4.solid.Ellipsoid("ellipsoid_solid4", 40., 60., 200., -10., 70.)
    ...
    ellipsoidSolid5    = _g4.solid.Ellipsoid("ellipsoid_solid5", 40., 60., 200., -10., 70.)
    ...
    ellipsoidSolid6    = _g4.solid.Ellipsoid("ellipsoid_solid6", 40., 60., 200., -10., 70.)
    ...
    ellipsoidSolid7    = _g4.solid.Ellipsoid("ellipsoid_solid7", 40., 60., 200., -10., 70.)
    ...
    ellipsoidSolid8    = _g4.solid.Ellipsoid("ellipsoid_solid8", 40., 60., 200., -10., 70.)
    ...
    ellipsoidSolid9    = _g4.solid.Ellipsoid("ellipsoid_solid9", 40., 60., 200., -10., 70.)
