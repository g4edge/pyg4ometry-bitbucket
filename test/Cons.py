...
def pycsgmeshTest(vtkViewer = True, gdmlWriter = True) :
    ...
    consSolid1    = _g4.solid.Cons("cons_solid1", 5, 10, 20, 25, 40, 0, (4./3.)*_np.pi)
    ...
    consSolid2    = _g4.solid.Cons("cons_solid2", 5, 10, 20, 25, 40, 0, (4./3.)*_np.pi)
    ...
    consSolid3    = _g4.solid.Cons("cons_solid3", 5, 10, 20, 25, 40, 0, (4./3.)*_np.pi)
    ...
    consSolid4    = _g4.solid.Cons("cons_solid4", 5, 10, 20, 25, 40, 0, (4./3.)*_np.pi)
    ...
    consSolid5    = _g4.solid.Cons("cons_solid5", 5, 10, 20, 25, 40, 0, (4./3.)*_np.pi)
    ...
    consSolid6    = _g4.solid.Cons("cons_solid6", 5, 10, 20, 25, 40, 0, (4./3.)*_np.pi)
    ...
    consSolid7    = _g4.solid.Cons("cons_solid7", 5, 10, 20, 25, 40, 0, (4./3.)*_np.pi)
    ...
    consSolid8    = _g4.solid.Cons("cons_solid8", 5, 10, 20, 25, 40, 0, (4./3.)*_np.pi)
