...
open source CAD/CAM program, which in turn is based on OpenCASCADE. FreeCAD allows for scripting in PYTHON 
and acts as a simple to use interface to OpenCASCADE.A STEP CAD file could be 
considered as a hierarchical tree of part assemblies and part features, where a part assembly is a 
...
for RT codes. Listing~\ref{lst:pythonCADLoading} shows how \PYGEOMETRY can load step files.
