...
significantly aid geometry creation workflows. A graphical user interface (GUI) would enable a user without any
...
The conversion which would most dramatically enhance the creation of geometry is CAD to Geant4 or FLUKA
...
The authors welcome contributions, extensions and bug fixes as well suggestions for larger collaborations.
