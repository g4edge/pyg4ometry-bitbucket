...
associated roto-translation from that lattice cell to the basic
...
In FLUKA every single point in space needs to be associated with one and only one region. There is problem 
