...
to FLUKA and conversely from FLUKA to GDML. The implementation of \PYGEOMETRY{} is explained in detail along with 
...
Python documentation generator. \PYGEOMETRY{} uses mature packages available for Python as dependencies. 
...
The unit tests also serve as minimal examples to help users understand the code operation.
