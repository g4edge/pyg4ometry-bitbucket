...
For maximum flexibility either backend can be used, but in general, the CGAL implementation is one to two orders of magnitude faster than the Cythonized CSG implementation and must be used for large geometries.
