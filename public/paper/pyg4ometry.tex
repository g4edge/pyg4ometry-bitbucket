...
\newcommand{\PYGEOMETRY}{Pyg4ometry}
...
There are existing codes that have functionality similar to \PYGEOMETRY{}. Tools exist to convert CAD files to GDML, open source examples are GUIMesh \cite{GUIMesh_Pinto}, commercial products include ESABASE2 \cite{ESABASE2} and FASTRAD \cite{FASTRAD}. There are also tools from the fusion and 
