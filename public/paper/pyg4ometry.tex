...
class in \PYGEOMETRY{}. The Python object initialiser is kept a similar to the Geant4 C++ constructor, but the length definitions are those used by GDML. For example, 
