...
sympy \cite{10.7717/peerj-cs.103} expression and using its \verb|logical| module. Before version 4.0 FLUKA 
would simplify all regions to DNF and some converted geometry would generate too many zones and would fail.
