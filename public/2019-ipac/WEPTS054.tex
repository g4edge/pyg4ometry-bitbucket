...
\ifboolexpr{bool{jacowbiblatex}}%
	...
	\bibitem{g4beamline} \url{http://www.muonsinternal.com/muons3/G4beamline}
	...
	\bibitem{mad8} MAD8 \url{http://mad8.web.cern.ch/mad8/}
	\bibitem{madx} MAD-X \url{http://madx.web.cern.ch/madx/}
	\bibitem{transport} PSI Graphic Transport Framework by U. Rohrer, based on a CERN-SLAC-FERMILAB version by K.L. Brown et al. 
	
	\bibitem{pyg4omtery-git} \url{https://bitbucket.org/jairhul/pyg4ometry/src/master/}
