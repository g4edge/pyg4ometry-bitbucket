...
cgal_extensions = {'pyg4ometry.pycgal.geom':['src/pyg4ometry/pycgal/geom.cxx'],
                   ...
                   'pyg4ometry.pycgal.Triangle_2': ['src/pyg4ometry/pycgal/Triangle_2.cxx'],
                   ...
                   'pyg4ometry.pycgal.Circle_3': ['src/pyg4ometry/pycgal/Circle_3.cxx'],
                   'pyg4ometry.pycgal.Direction_3': ['src/pyg4ometry/pycgal/Direction_3.cxx'],
                   'pyg4ometry.pycgal.Iso_cuboid_3': ['src/pyg4ometry/pycgal/Iso_cuboid_3.cxx'],
                   'pyg4ometry.pycgal.Line_3': ['src/pyg4ometry/pycgal/Line_3.cxx'],
                   'pyg4ometry.pycgal.Plane_3': ['src/pyg4ometry/pycgal/Plane_3.cxx'],
                   'pyg4ometry.pycgal.Point_3': ['src/pyg4ometry/pycgal/Point_3.cxx'],
                   'pyg4ometry.pycgal.Ray_3': ['src/pyg4ometry/pycgal/Ray_3.cxx'],
                   'pyg4ometry.pycgal.Segment_3': ['src/pyg4ometry/pycgal/Segment_3.cxx'],
...
def pybind11_OCE_extensions(extDict, config) :
    ...
    for ext in extDict :
        ...
        extension = Extension(ext,
                              ...
                              libraries = ['TKBO','TKBRep','TKBin','TKBinL','TKBinTObj','TKBinXCAF','TKBool','TKCAF','TKCDF','TKDCAF','TKDraw',
                                           'TKFeat','TKFillet','TKG2d','TKG3d','TKGeomAlgo','TKGeomBase','TKHLR','TKIGES','TKLCAF','TKMath',
                                           'TKMesh','TKMeshVS','TKOffset','TKPrim','TKRWMesh','TKSTEP','TKSTEP209',
                                           'TKSTEPAttr','TKSTEPBase','TKSTL','TKService','TKShHealing','TKStd','TKStdL','TKTObj',
                                           'TKTopAlgo','TKTopTest','TKVCAF','TKVRML','TKViewerTest','TKXCAF',
                                           'TKXDEDRAW','TKXDEIGES','TKXDESTEP','TKXMesh','TKXSBase','TKXml','TKXmlL',
