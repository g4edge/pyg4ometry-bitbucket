...
usd_ext = Extension('pyg4ometry.pyusd.usd',
                    include_dirs = ['/Users/sboogert/Physics/coderepos/USD/.install/include',
                                    pybind11_include,
                                    '/opt/local/include/',
                                    './pyg4ometry/pycgal/'],
                    library_dirs = ['/Users/sboogert/Physics/coderepos/USD/.install/lib'],
                    libraries = ['usd_usd','usd_usdGeom'],
