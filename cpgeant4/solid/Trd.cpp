...
CSG* CSGMesh::ConstructTrd(double pX1,double pX2,double pY1,double pY2,double pZ){
  ...
  vtx1[4] = new Vertex(new Vector( pX1,-pY1,-pZ), NULL);
  ...
  vtx2[4] = new  Vertex(new Vector(-pX2, pY2, pZ), NULL);
  ...
  vtx3[4] = new  Vertex(new Vector(-pX2,-pY2, pZ), NULL);
  ...
  vtx4[4] = new  Vertex(new Vector( pX1, pY1,-pZ), NULL);
  ...
  vtx5[4] = new  Vertex(new Vector(-pX1, pY1,-pZ), NULL);
  ...
  vtx6[4] = new  Vertex(new Vector( pX2,-pY2, pZ), NULL);
