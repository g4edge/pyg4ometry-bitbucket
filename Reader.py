...
class Reader : 
    def __init__(self, fileName) : 
        ...
        self.flukaBodyDict  = {'RPP':['name','xmin','xmax','ymin','ymax','zmin','zmax'],
        ...
        # keyword list 
        self.flukaBodyKw    = self.flukaBodyDict.keys()
        self.flukaCommandKw = self.flukaCommandDict.keys()
    ...
    def comprehend(self) : 
        ...
        for l in self.readFile : 
            ...
            # check if command
            try :
                self.flukaCommandKw.index(sl[0])
                continue
            except ValueError : 
                pass
